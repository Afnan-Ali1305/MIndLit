...
const moviesList = [
    ...
    { id: 3, title: "Interstellar", thumbnail: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=500&q=80", videoUrl: "https://www.youtube.com/embed/zSWdZVtXT7E" },
    { id: 4, title: "The Dark Knight", thumbnail: "https://images.unsplash.com/photo-1478760329108-5c3ed9d495a0?w=500&q=80", videoUrl: "https://www.youtube.com/embed/EXeTwQWrcwY" },
    { id: 5, title: "Spiderman: No Way Home", thumbnail: "https://images.unsplash.com/photo-1635805737707-575885ab0820?w=500&q=80", videoUrl: "https://www.youtube.com/embed/JfVOs4VSpmA" },
    { id: 6, title: "Inception", thumbnail: "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=500&q=80", videoUrl: "https://www.youtube.com/embed/YoHD9XEInc0" }
];
...
function initIndexPage() {
    ...
    function renderMovies() {
        ...
        moviesToDisplay.forEach((movie, index) => {
            ...
            // Grid Inline Ad Loop Injection (Every 4 items)
            if ((index + 1) % 4 === 0) {
                const inlineAdCard = document.createElement("div");
                inlineAdCard.className = "bg-gray-950 rounded-lg p-3 flex flex-col items-center justify-center text-center border border-dashed border-gray-700 min-h-[250px] overflow-hidden";
                inlineAdCard.innerHTML = `
                    <p class="text-[10px] text-gray-600 mb-2 uppercase tracking-widest">Sponsored Advertisement</p>
                    <div class="w-full flex justify-center items-center min-h-[250px]">
    ...
    if (prevBtn) {
        prevBtn.addEventListener('click', () => {
            if (currentPage > 1) { currentPage--; renderMovies(); window.scrollTo({ top: 0 }); }
        });
    }
    ...
    if (nextBtn) {
        nextBtn.addEventListener('click', () => {
            ...
            if (currentPage < totalPages) { currentPage++; renderMovies(); window.scrollTo({ top: 0 }); }
        });
    }
